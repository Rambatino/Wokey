...
func TestCheckForState(t *testing.T) {
	...
	cases := []struct {
		...
		{"New Issue Comment", []pullRequest{}, []issue{{ID: "123", Key: "EPIC/EPIC-23", Title: "Title 1"}}, []pullRequest{}, []issue{{ID: "123", Key: "EPIC/EPIC-23", Title: "Title 1", Comments: comment{Count: 1}}}, []stateChange{{Type: "NEW_ISSUE_COMMENT", Message: "'Title 1' [EPIC/EPIC-23] has 1 new comment(s)", CreatedAt: now}}, 1},
		{"New PR Comment", []pullRequest{{ID: "123", Repo: "Rambatino/CHAID", Title: "My PR", Number: 299}}, []issue{}, []pullRequest{{ID: "123", Repo: "Rambatino/CHAID", Title: "My PR", Comments: comment{Count: 1}, Number: 299}}, []issue{}, []stateChange{{Type: "NEW_PULL_REQUEST_COMMENT", Message: "#299 'My PR' [Rambatino/CHAID] has 1 new comment(s)", CreatedAt: now}}, 1},
		{"New PR Comment inside an Issue", []pullRequest{{ID: "123", Repo: "Rambatino/CHAID", Title: "My PR", Number: 299}}, []issue{{PullRequests: []pullRequest{{ID: "1233", Repo: "Rambatino/CHAID", Title: "My Other PR", Number: 300}}, Title: "hello", Key: "EPIC-2"}}, []pullRequest{{ID: "123", Repo: "Rambatino/CHAID", Title: "My PR", Comments: comment{Count: 1}, Number: 299}, {ID: "1233", Repo: "Rambatino/CHAID", Title: "My Other PR", Number: 300, Comments: comment{Count: 1}}}, []issue{{PullRequests: []pullRequest{{ID: "1233", Repo: "Rambatino/CHAID", Title: "My Other PR", Comments: comment{Count: 1}, Number: 300}}, Title: "hello", Key: "EPIC-2"}}, []stateChange{{Type: "NEW_PULL_REQUEST_COMMENT", Message: "#299 'My PR' [Rambatino/CHAID] has 1 new comment(s)", CreatedAt: now}, {Type: "NEW_PULL_REQUEST_COMMENT", Message: "#300 'My Other PR' [Rambatino/CHAID] has 1 new comment(s)", CreatedAt: now}}, 2},
		{"New Column Change", []pullRequest{}, []issue{{ID: "123", Key: "EPIC/EPIC-23", Title: "Title 1", State: "Ready to Merge"}}, []pullRequest{}, []issue{{State: "Code Review", ID: "123", Key: "EPIC/EPIC-23", Title: "Title 1", Comments: comment{Count: 1}}}, []stateChange{{Type: "NEW_ISSUE_COMMENT", Message: "'Title 1' [EPIC/EPIC-23] has 1 new comment(s)", CreatedAt: now}, {Type: "COLUMN_CHANGE", Message: "'Title 1' [EPIC/EPIC-23] has been moved from 'Ready to Merge' to 'Code Review'", CreatedAt: now}}, 2},

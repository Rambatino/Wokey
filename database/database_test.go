...
func TestFormatState(t *testing.T) {
	cases := []struct {
		...
		{"New Pull Request Assigned to Issue", []pullRequest{{ID: "123", Branch: "feature/EPIC-1", Repo: "Rambatino/CHAID"}, {ID: "1", Branch: "feature/EPIC-1", Repo: "Rambatino/OTHER-REPO"}}, []issue{{ID: "123", Key: "EPIC-1", Title: "Title 1"}}, state{PullRequests: []pullRequest{}, Changes: []stateChange{}, Issues: []issue{{ID: "123", Key: "EPIC-1", Title: "Title 1", PullRequests: []pullRequest{{ID: "123", Branch: "feature/EPIC-1", Repo: "Rambatino/CHAID"}, {ID: "1", Branch: "feature/EPIC-1", Repo: "Rambatino/OTHER-REPO"}}}}}},
		{"New Pull Request Assigned to Issue and other one not", []pullRequest{{ID: "123", Branch: "feature/EPIC-2", Repo: "Rambatino/CHAID"}, {ID: "1", Branch: "feature/EPIC-1", Repo: "Rambatino/OTHER-REPO"}}, []issue{{ID: "123", Key: "EPIC-1", Title: "Title 1"}}, state{PullRequests: []pullRequest{{ID: "123", Branch: "feature/EPIC-2", Repo: "Rambatino/CHAID"}}, Changes: []stateChange{}, Issues: []issue{{ID: "123", Key: "EPIC-1", Title: "Title 1", PullRequests: []pullRequest{{ID: "1", Branch: "feature/EPIC-1", Repo: "Rambatino/OTHER-REPO"}}}}}},
	}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
